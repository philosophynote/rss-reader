...
class TestDynamoDBClient:
    ...
    def test_get_item_success(self, client, mock_table):
        """アイテム取得の成功テスト"""
        expected_item = {'PK': 'TEST#123', 'SK': 'METADATA', 'data': 'test data'}
        mock_table.get_item.return_value = {'Item': expected_item}
        
        result = client.get_item('TEST#123', 'METADATA')
        
        assert result == expected_item
        mock_table.get_item.assert_called_once_with(Key={'PK': 'TEST#123', 'SK': 'METADATA'})
    ...
    def test_delete_item_success(self, client, mock_table):
        ...
        mock_table.delete_item.assert_called_once_with(Key={'PK': 'TEST#123', 'SK': 'METADATA'})
    ...
    def test_query_articles_for_deletion_by_age(self, client, mock_table):
        ...
        mock_table.query.return_value = {'Items': expected_items, 'LastEvaluatedKey': None}
    ...
    def test_delete_importance_reasons_for_article(self, client, mock_table):
        ...
        mock_table.query.return_value = {'Items': reasons, 'LastEvaluatedKey': None}
        ...
        mock_batch.delete_item.assert_any_call(Key={'PK': 'ARTICLE#123', 'SK': 'REASON#keyword1'})
        mock_batch.delete_item.assert_any_call(Key={'PK': 'ARTICLE#123', 'SK': 'REASON#keyword2'})
    ...
    def test_generate_reverse_sort_key(self, client):
        ...
        for score, expected in test_cases:
            ...
            assert result == expected, f"Score {score} should generate {expected}, got {result}"
