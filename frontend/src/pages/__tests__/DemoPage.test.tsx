...
describe("DemoPage", () => {
  ...
  it("should render tabs correctly", () => {
    ...
    expect(screen.getByText("このページについて")).toBeInTheDocument();
  });
  ...
  it("should switch to about tab when clicked", async () => {
    ...
    const aboutTab = screen.getByText("このページについて");
    await user.click(aboutTab);

    expect(screen.getByText("このページについて")).toBeInTheDocument();
    expect(screen.getByText("実装状況")).toBeInTheDocument();
    expect(screen.getByText("確認できる機能")).toBeInTheDocument();
